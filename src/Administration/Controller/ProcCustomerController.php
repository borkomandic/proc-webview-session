...
namespace ProCoders\WebViewSession\Administration\Controller;
...
class ProcCustomerController extends AbstractController
{
    ...
    #[Route('/api/proc-webview-customer', name: 'api.proc_webview.customer', methods: ['POST'])]
